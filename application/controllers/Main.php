...
class Main extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = 'Dasbor Ester Laundry';
		...
		if (isset($_POST['cari_tanggal'])) {
			...
			// super administrator
				...
				$data['transaksiLaporan'] = $this->lm->getTransaksiLaporanSortTglIndex($tanggal_awal, $tanggal_akhir)->result_array();
				$data['jumlah_transaksi'] = $this->lm->getTransaksiLaporanSortTglIndex($tanggal_awal, $tanggal_akhir)->row_array();
